...
$loc_search = "Шукати";
$loc_salt = "«Сіль»";
$loc_no_matches = "Не знайдено відповідних записів.";
$loc_entry_not_found = "Указаного запису не існує.";
$loc_text = "Текст";
$loc_tags = "Категорії";
$loc_files = "Файли";
$loc_title = "Заголовок";
...
$loc_file_uploaded = "Файл %s завантажено як %s.";
$loc_uploading_failed = "Не вдалося завантажити файл %s.";
$loc_uploading_failed_file_exists = "Не вдалося завантажити файл %s: файл вже існує";
