...
$loc_search = "Search";
$loc_salt = "Salt";
$loc_no_matches = "No matching entries found.";
$loc_entry_not_found = "The entry you've specified doesn't exist.";
$loc_text = "Text";
$loc_tags = "Tags";
$loc_files = "Files";
$loc_title = "Title";
...
$loc_file_uploaded = "File %s uploaded successfully as %s.";
$loc_uploading_failed = "Couldn't upload the file %s.";
$loc_uploading_failed_file_exists = "Couldn't upload the file %s: file exists.";
...
$loc_delete = "Delete";
$loc_delete_prompt_entry = "Are you sure you want to delete this entry?";
$loc_delete_prompt_file = "Are you sure you want to delete %s?";
